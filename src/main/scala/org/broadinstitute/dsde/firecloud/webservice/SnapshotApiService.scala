...
object SnapshotApiService {
  ...
  def listDataRepoSnapshotURL(namespace:String, name:String, offset:String, limit:String) = rawlsBasePath + s"/workspaces/${namespace}/${name}/snapshots?limit=" + limit + "&offset=" + offset
