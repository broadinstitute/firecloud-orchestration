...
class WorkspaceServiceSpec extends BaseServiceSpec with BeforeAndAfterEach {
  ...
  val customApp = Application(agoraDao, googleServicesDao, ontologyDao, consentDao, new MockRawlsDeleteWSDAO(), samDao, new MockSearchDeleteWSDAO(), new MockResearchPurposeSupport, thurloeDao, trialDao, new MockLogitDAO, new MockShareLogDAO, new MockCromIAMDAO)
