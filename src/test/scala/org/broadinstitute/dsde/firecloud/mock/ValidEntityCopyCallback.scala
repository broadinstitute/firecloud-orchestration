...
import org.broadinstitute.dsde.firecloud.model.EntityCopyWithDestinationDefinition
...
class ValidEntityCopyCallback extends ExpectationCallback {
  ...
  override def handle(httpRequest: HttpRequest): HttpResponse = {
    ...
    val copyRequest = httpRequest.getBodyAsString.parseJson.convertTo[EntityCopyWithDestinationDefinition]
