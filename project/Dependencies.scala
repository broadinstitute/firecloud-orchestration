...
object Dependencies {
  ...
  val rootDependencies: Seq[ModuleID] = Seq(
    ...
    excludeGuava("org.broadinstitute.dsde"       %% "rawls-model"         % "v0.0.194-SNAP")
    ...
    "org.broadinstitute.dsde.workbench" %% "sam-client"       % "v0.0.284",
    ...
    "com.google.cloud"               % "google-cloud-nio"    % "0.127.24" % "test",
