...
object Dependencies {
  ...
  val transitiveDependencyOverrides: Seq[ModuleID] = Seq(
    ...
    "com.google.apis" % "google-api-services-admin-directory" % "directory_v1-rev20251124-2.0.0" // from workbench-google2
  )
  ...
  val rootDependencies: Seq[ModuleID] = Seq(
    ...
    "org.springframework" % "spring-web" % "7.0.3" excludeAll (excludeSpringBoot, excludeSpringJcl),
