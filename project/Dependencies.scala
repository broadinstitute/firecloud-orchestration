...
object Dependencies {
  ...
  val rootDependencies: Seq[ModuleID] = Seq(
    ...
    excludeGuava("org.broadinstitute.dsde"       %% "rawls-model"         % "0.1-1bd0a855")
    ...
    "org.elasticsearch.client"       % "transport"           % "7.17.12" // pin to this version; it's the latest compatible with our elasticsearch server
