...
object Dependencies {
  ...
  val rootDependencies: Seq[ModuleID] = Seq(
    ...
    "org.elasticsearch.client"       % "transport"           % "7.17.9" // pin to this version; it's the latest compatible with our elasticsearch server
    ...
    "com.google.cloud"               % "google-cloud-nio"    % "0.126.3" % "test",
